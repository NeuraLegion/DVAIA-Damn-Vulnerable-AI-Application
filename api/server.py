...
Load .env via python -m api (api/__main__.py). PORT, DEFAULT_MODEL, OPENAI_API_KEY.
"""
import os
import tempfile
...
def api_models():
    ...
    return jsonify({
        ...
        "format": "Use 'model_id' in POST body. OpenAI models: e.g. gpt-4o-mini, gpt-4o",
...
def api_chat():
    ...
    - model_id: optional (for example "gpt-4o-mini")
    - options: optional dict for generation (max_tokens, temperature, top_p) to cap output length.
